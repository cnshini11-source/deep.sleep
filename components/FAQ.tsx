...
const faqItems: FaqItem[] = [
  ...
  },
  {
    ...
    answer: "אנחנו כאן כדי לוודא שאתם מרוצים. המערכת שלנו כוללת 3 פתרונות משלימים בערכה אחת (מכשיר חכם, פותחי נשימה וכיסוי 3D) כדי להבטיח מענה רחב ככל הניתן לטיפול בנחירות. אם יש לכם קושי בתפעול או שאלות נוספות, שירות הלקוחות שלנו בווצאפ זמין לכם לליווי אישי עד להשגת התוצאה הרצויה."
  },
  {
    question: "איך מטעינים את המכשיר וכמה זמן מחזיקה הסוללה?",
    answer: "המכשיר מגיע עם כבל טעינה USB-C מהיר. טעינה מלאה אורכת כשעתיים ומספיקה ל-2 עד 3 לילות של שימוש רצוף ללא נחירות. נורית חיווי על המכשיר תסמן לך מתי הסוללה חלשה."
  }
];
